...
class DraftOrderTest(TestCase):
    ...
    def test_get_all_draft_orders(self):
        ...
        draft_orders = shopify_api.DraftOrder.find()
    ...
    def test_get_count_draft_orders(self):
        ...
        draft_orders_count = shopify_api.DraftOrder.count()
    ...
    def test_create_draft_order(self):
        ...
        draft_order = shopify_api.DraftOrder.create({"line_items": [{"quantity": 1, "variant_id": 39072856}]})
    ...
    def test_send_invoice_with_no_params(self):
        ...
        self.assertIsInstance(draft_order_invoice_response, shopify_api.DraftOrderInvoice)
    ...
    def test_send_invoice_with_params(self):
        ...
        draft_order_invoice = json.loads(draft_order_invoice_fixture.decode("utf-8"))
        self.fake('draft_orders/517119332/send_invoice', method='POST', body=draft_order_invoice_fixture, headers={'Content-type': 'application/json'})
        draft_order_invoice_response = self.draft_order.send_invoice(shopify_api.DraftOrderInvoice(draft_order_invoice['draft_order_invoice']))
    ...
    def test_add_metafields_to_draft_order(self):
        ...
        field = self.draft_order.add_metafield(shopify_api.Metafield({'namespace': 'contact', 'key': 'email', 'value': '123@example.com', 'value_type': 'string'}))
    ...
    def test_get_metafields_for_draft_order(self):
        ...
        self.assertIsInstance(metafields[0], shopify_api.Metafield)
        self.assertIsInstance(metafields[1], shopify_api.Metafield)

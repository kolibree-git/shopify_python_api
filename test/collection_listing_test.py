...
class CollectionListingTest(TestCase):
    ...
    def test_get_collection_listings(self):
        ...
        collection_listings = shopify_api.CollectionListing.find()
    ...
    def test_get_collection_listing(self):
        ...
        collection_listing = shopify_api.CollectionListing.find(1)
    ...
    def test_reload_collection_listing(self):
        ...
        collection_listing = shopify_api.CollectionListing()

...
class UsageChargeTest(TestCase):
    def test_create_usage_charge(self):
        ...
        charge = shopify_api.UsageCharge({'price': 9.0, 'description': '1000 emails', 'recurring_application_charge_id': 654381177})
        charge.save()
    ...
    def test_get_usage_charge(self):
        ...
        charge = shopify_api.UsageCharge.find(359376002, recurring_application_charge_id= 654381177)
        self.assertEqual('1000 emails', charge.description)

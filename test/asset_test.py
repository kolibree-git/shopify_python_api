...
class AssetTest(TestCase):
    ...
    def test_get_asset(self):
        ...
        v = shopify_api.Asset.find('templates/index.liquid')
    ...
    def test_get_assets_namespaced(self):
        ...
        v = shopify_api.Asset.find(theme_id = 1)
    ...
    def test_get_asset_namespaced(self):
        ...
        v = shopify_api.Asset.find('templates/index.liquid', theme_id=1)
    ...
    def test_attach(self):
        ...
        theme_id = 1
        asset = shopify_api.Asset({'key': key, 'theme_id': theme_id})

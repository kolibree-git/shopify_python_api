...
class StorefrontAccessTokenTest(TestCase):
    def test_create_storefront_access_token(self):
        ...
        storefront_access_token = shopify_api.StorefrontAccessToken.create({'title': 'Test'})
    ...
    def test_get_and_delete_storefront_access_token(self):
        ...
        storefront_access_token = shopify_api.StorefrontAccessToken.find(1)
    ...
    def test_get_storefront_access_tokens(self):
        ...
        tokens = shopify_api.StorefrontAccessToken.find()

...
class ImageTest(TestCase):
    ...
    def test_create_image(self):
        ...
        image = shopify_api.Image({'product_id':632910392})
        image.position = 1
        ...
        self.assertEqual('http://cdn.shopify_api.com/s/files/1/0006/9093/3842/products/ipod-nano.png?v=1389388540', image.src)
    ...
    def test_get_metafields_for_image(self):
        ...
        image = shopify_api.Image(attributes = {'id': 850703190, 'product_id': 632910392})

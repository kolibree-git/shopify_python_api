...
class VariantTest(TestCase):
    ...
    def test_get_variants(self):
        ...
        v = shopify_api.Variant.find(product_id = 632910392)
    ...
    def test_get_variant_namespaced(self):
        ...
        v = shopify_api.Variant.find(808950810, product_id = 632910392)
    ...
    def test_create_variant(self):
        ...
        v = shopify_api.Variant({'product_id':632910392})
        v.save()
    ...
    def test_get_variant(self):
        ...
        v = shopify_api.Variant.find(808950810)

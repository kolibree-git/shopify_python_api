...
class PriceRuleTest(TestCase):
    ...
    def setUp(self):
        ...
        self.price_rule = shopify_api.PriceRule.find(1213131)
    ...
    def test_get_all_price_rules(self):
        ...
        price_rules = shopify_api.PriceRule.find()
    ...
    def test_price_rule_creation(self):
        ...
        price_rule = shopify_api.PriceRule.create({
            "title": "BOGO",
    ...
    def test_add_discount_code(self):
        ...
        self.fake('price_rules/1213131/discount_codes',
                  ...
                  headers={'Content-type': 'application/json'})
        price_rule_discount_response = self.price_rule.add_discount_code(shopify_api.DiscountCode(discount_code['discount_code']))
        self.assertEqual(discount_code, json.loads(self.http.request.data.decode("utf-8")))
        self.assertIsInstance(price_rule_discount_response, shopify_api.DiscountCode)
